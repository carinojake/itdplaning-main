                ...
                <div class="row">
                                                ...
                                                <div class="mb-2 row ">
                                                    ...
                                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                                        <div class="card ">
                                                            ...
                                                            <!--  <div class="progress progress-thin">
                                                        <div class="progress-bar bg-success" role="progressbar" style="width: 4%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">4%</div>
                                                    </div> -->
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                                        <div class="card ">
                                                            ...
                                                            <!--   <div class="progress progress-thin">
                                                        <div class="progress-bar bg-success" role="progressbar" style="width: 1%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"> 1%</div>
                                                    </div>-->
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span style="color: #dc3545 ">การใช้จ่ายงบประมาณ</span>
                                            </button>
                                        </h2>
                                                ...
                                                <div class="mb-2 row ">
                                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                                        <div class="card ">
                                                            <div class="card-body">
                                                                <div class="fs-4 fw-semibold ">
                                                        <span style="color: #dc3545 ">{{ Helper::millionFormat($coats) }}</span>
                                                                </div>
                                                                <svg class="icon icon-xl text-end">
                                                                    <use
                                                                        xlink:href=" {{ asset('vendors/@coreui/icons/sprites/free.svg#cil-money') }}">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <span style="color: #6f42c1 "> คงเหลือ </span>
                                            </button>
                                        </h2>
                    ...
                    <div class="col-sm-2 " >
                        <div class="card"  href="#" role="button">
                            <div class="card-body ">
                                <a class="btn btn-outline-primary" href="/itdplaning-main/public/project" role="button">
                                    ...
                                    <small class="text-medium-emphasis text-uppercase fw-semibold">งานประจำ</small></a>
                        ...
                        <div class="card">
                            <div class="card-body ">
                                <a class="btn btn-outline-primary" href="/itdplaning-main/public/project/7dnamnzl" role="button">
                            ...
                            <small class="text-medium-emphasis text-uppercase fw-semibold">โครงการ</small></a>

                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body ">
                                <!--<a href="/itdplaning-main/public/contract" class="btn btn-primary disabled" tabindex="-1" role="button" aria-disabled="true">Primary link</a>
                    -->

                                   <a class="btn btn-outline-primary" href="/itdplaning-main/public/contract" role="button">
                                        ...
                                        <small class="text-medium-emphasis text-uppercase fw-semibold">สัญญา</small></a>
...
chart.set("cursor", am5xy.XYCursor.new(root, {}));
    ...
    //createSeries("การใช้จ่ายประมาณ", "total_cost")
