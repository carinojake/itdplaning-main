          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <x-card title="{{ __('เพิ่มค่าใช้จ่าย ( ครั้งเดียว/งวด)') }}">
             <form method="POST" action="{{ route('contract.task.store', $contract) }}" class="row g-3">
                ...
                <div class="col-md-12">
                  <label for="taskcon_name" class="form-label">{{ __('ชื่อ งวด') }}</label> <span class="text-danger">*</span>
                ...
                <div class="col-md-12">
                  <label for="taskcon_description" class="form-label">{{ __('รายละเอียด งวด') }}</label>
                  ...
                  <div class="row mt-3 ">
                    ...
                    <div class="col-6">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="text" placeholder="0.00" step="0.01"http://127.0.0.1/itdplaning-main/public/contract
                        data-inputmask="'alias': 'decimal', 'groupSeparator': ','"
                         class="form-control numeral-mask"
