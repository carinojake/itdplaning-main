                ...
                <div class="col-md-12">
                  ...
                  <select name="task_parent" id="task_parent" class="from-control">
                    ...
                    @foreach ($tasks as $subtask)
                      <option value="{{ $subtask->task_id }}" {{ $task->task_parent == $subtask->task_id ? 'selected' : '' }}>{{ $subtask->task_name }}</option>
                    @endforeach
                  </select>
                  <div class="invalid-feedback">
                    {{ __('กิจกรรมย่อย') }}
                  ...
                  <select name="task_contract" id="task_contract" class="from-control">
                    ...
                    @foreach ($contracts as $contract)
                      @if ($task->contract->count() > 0 && $contract->contract_id == $task->contract->first()->contract_id)
                        <option value="{{ $contract->contract_id }}"selected>[{{ $contract->contract_number }}]{{ $contract->contract_name }}</option>
                      @else
                  ...
                  <div class="row">
                    <div class="col-6">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_budget_gov_operating" name="task_budget_gov_operating" min="0" value="{{ $task->task_budget_gov_operating }}">
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_budget_gov_investment" name="task_budget_gov_investment" min="0" value="{{ $task->task_budget_gov_investment }}">
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_budget_gov_utility" name="task_budget_gov_utility" min="0" value="{{ $task->task_budget_gov_utility }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_budget_it_operating" name="task_budget_it_operating" min="0" value="{{ $task->task_budget_it_operating }}">
                        <div class="invalid-feedback">
                          {{ __('ระบุงบดำเนินงาน (ค่าใช้สอยต่างๆ)') }}
                        </div>
                      </div>
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_budget_it_investment" name="task_budget_it_investment" min="0" value="{{ $task->task_budget_it_investment }}">
                        <div class="invalid-feedback">
                          {{ __('ระบุงบลงทุน IT (ครุภัณฑ์ต่างๆ)') }}
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_cost_gov_operating" name="task_cost_gov_operating" min="0" value="{{ $task->task_cost_gov_operating }}">
                        <div class="invalid-feedback">
                          {{ __('ระบุงบดำเนินงาน (ค่าใช้สอยต่างๆ)') }}
                        </div>
                      </div>
                      <div class="col-md-12">
                        ...
                        <input type="number" placeholder="0.00" step="0.01" class="form-control" id="task_cost_gov_investment" name="task_cost_gov_investment" min="0" value="{{ $task->task_cost_gov_investment }}">
                        <div class="invalid-feedback">
                          {{ __('ระบุงบลงทุน IT (ครุภัณฑ์ต่างๆ)') }}
                        </div>
                      </div>
