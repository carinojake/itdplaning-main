...
//2
    ...
    //   dd($task_sub_sums,$task_sub,$latestContract,$results,$taskcons,$contract,$project,$task);
        return view('app.projects.tasks.show', compact('task_sub_op_sums','taskcons', 'project', 'task', 'results', 'contract', 'latestContract', 'sum_task_budget_it_operating', 'sum_task_budget_it_investment', 'sum_task_budget_gov_utility'));
    }
